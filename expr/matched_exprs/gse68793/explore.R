...
marr <- qread("./gse68793_exprs-matched.rds")
...
.compare_sample("TCGA-18-3406")
.compare_sample("TCGA-18-3406", smooth = TRUE)

.compare_sample("TCGA-18-3409")
.compare_sample("TCGA-18-3409", smooth = TRUE)
