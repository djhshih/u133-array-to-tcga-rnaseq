...
marr <- qread("./gse68850_exprs-matched.rds")
...
.compare_sample("TCGA-06-0178")
.compare_sample("TCGA-06-0178", smooth = TRUE)

.compare_sample("TCGA-06-0190")
.compare_sample("TCGA-06-0190", smooth = TRUE)
