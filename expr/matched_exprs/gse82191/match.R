...
microarray_exprs <- qread("../../raw_exprs/u133/gse82191/gse82191_exprs.rds");

dim(rna_exprs) # 20531 11069
rna_exprs[1:3, 1:4]

dim(microarray_exprs) # 22277   527
...
dim(microarray_exprs) # 22277   296
dim(rna_exprs) # 20531   296
...
dim(microarray_exprs_m) # 22277   296

microarray_exprs_m <- collapse_duplicate_probe(microarray_exprs_m);
dim(microarray_exprs_m) # 13039   296
